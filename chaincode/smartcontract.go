...
func (s *SmartContract) CreateOrder(ctx contractapi.TransactionContextInterface, pizza string, ID int,
price float32, holder string, datetime string, location string) error {
...
func (s *SmartContract) UpdateOrder(ctx contractapi.TransactionContextInterface, id int,
  holder string) error {
  exists, err := s.OrderExists(ctx, id)
  if err != nil {
    return err
...
func (s *SmartContract) ReadOrder(ctx contractapi.TransactionContextInterface, id string) (*Asset, error) {
...
func (s *SmartContract) TransferOrder(ctx contractapi.TransactionContextInterface, ID int, owner string) error {
